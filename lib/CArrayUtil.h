 ...
 * @param P array
 */
#define ARRAY_FREE(P) ((void)CARR_array_realloc((void**)&(P), alignof(__typeof__(*(P))), sizeof(*(P)), 0))
...
#define ARRAY_TRY_ENSURE_CAPACITY(P, CAPACITY) \
    CARR_array_ensure_capacity((void**)&(P), alignof(__typeof__(*(P))), sizeof(*(P)), (CAPACITY), false)
...
#define ARRAY_ENSURE_CAPACITY(P, CAPACITY) \
    ((void)CARR_array_ensure_capacity((void**)&(P), alignof(__typeof__(*(P))), sizeof(*(P)), (CAPACITY), true))
 ...
 * @return true if the operation succeeded
 */
#define ARRAY_SHRINK_TO_FIT(P) CARR_array_realloc((void**)&(P), alignof(__typeof__(*(P))), sizeof(*(P)), ARRAY_SIZE(P))
...
#define ARRAY_TRY_RESIZE(P, SIZE) \
    CARR_array_resize((void**)&(P), alignof(__typeof__(*(P))), sizeof(*(P)), (SIZE), false)
...
#define ARRAY_RESIZE(P, SIZE) \
    ((void)CARR_array_resize((void**)&(P), alignof(__typeof__(*(P))), sizeof(*(P)), (SIZE), true))
...
#define ARRAY_PUSH_BACK(P) \
    (*(CARR_array_push_back((void**)&(P), alignof(__typeof__(*(P))), sizeof(*(P))), (P) + ARRAY_SIZE(P) - 1))
...
#define RING_BUFFER_TRY_ENSURE_CAN_PUSH(P) CARR_RING_BUFFER_GUARD((P), \
    CARR_ring_buffer_ensure_can_push((void**)&(P), alignof(__typeof__(*(P))), sizeof(*(P)), false))
...
#define RING_BUFFER_ENSURE_CAN_PUSH(P) CARR_RING_BUFFER_GUARD((P), \
    (void)CARR_ring_buffer_ensure_can_push((void**)&(P), alignof(__typeof__(*(P))), sizeof(*(P)), true))
...
#define RING_BUFFER_FREE(P) CARR_RING_BUFFER_GUARD((P), \
    (void)CARR_ring_buffer_realloc((void**)&(P), alignof(__typeof__(*(P))), sizeof(*(P)), 0))
